export default function PointsDisplay({ points, highScore, walletAddress, onLogout }) {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 flex flex-col md:flex-row justify-between items-center flex-wrap gap-4 mb-5">
      <div className="flex gap-8 flex-wrap justify-around md:justify-start">
