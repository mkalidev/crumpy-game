...
export const contractABI = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'finalScore', type: 'uint256' }],
    name: 'endGame',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
    ...
    outputs: [
      {
        ...
        internalType: 'struct Game2048.GameSession[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: '_highScore', type: 'uint256' },
      { internalType: 'uint256', name: '_totalScore', type: 'uint256' },
      { internalType: 'uint256', name: '_rewardPoints', type: 'uint256' },
      { internalType: 'uint256', name: '_claimedRewards', type: 'uint256' },
...
export const contractAddress =
  process.env.NEXT_PUBLIC_CONTRACT_ADDRESS || '0xF566eAa0B8470817aB0A1A0846A8B9E9f3325885';
